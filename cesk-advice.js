...
// an advice function could look like this
//  imagine modifying each advice in this file to be something like this example function
...
ceskAdvice.arrival = advice => (callee, newtarget, self, arguments, serial) => {
